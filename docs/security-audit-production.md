...
- Browser: all five final isolated Playwright journeys passed in 1.3 minutes against PostgreSQL 18.4, native Mailpit, the hardened backend and a dedicated Vite port. This covers independent accounts, lobby lifecycle, formation/chat/move/terminal history, ranked exactly-once rating, outsider REST/STOMP denial, rank secrecy and inert hostile chat.
